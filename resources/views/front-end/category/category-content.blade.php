			...
			<div class="product-agileinfo-grids w3l">
				...
				<div class="col-md-9 product-agileinfon-grid1 w3l">
					...
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						...
						<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><img src="{{ URL::asset('/') }}front-end/images/menu1.png"></a></li>
						<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="{{ URL::asset('/') }}front-end/images/menu.png"></a></li>
						</ul>
									...
									<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
										<div class="grid-arr">
											<div  class="grid-arrival">
												<figure>		
													<a href="{{ route('product-details',['id'=>$publishedCategoryProduct->id,'name'=>$publishedCategoryProduct->productName]) }}" class="new-gri"> 
														<div class="grid-img">
											...
											<div class="women">
												<h6><a href="{{ route('product-details', ['id'=>$publishedCategoryProduct->id,'name'=>$publishedCategoryProduct->productName]) }}">{{ $publishedCategoryProduct->productName }}</a></h6>
											...
											<div  class="grid-arrival">
												<figure>		
													<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
														<div class="grid-img">
															<img  src="{{ URL::asset('/') }}front-end/images/i8.jpg" class="img-responsive" alt="">
														</div>
														<div class="grid-img">
															<img  src="{{ URL::asset('/') }}front-end/images/i7.jpg" class="img-responsive"  alt="">
														</div>			
													</a>		
												</figure>	
											</div>
